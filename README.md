...
翻訳したい/追加したいリポジトリがあれば Issue で提案してください。

最終更新: 2025-12-31

注意）
- 開始年月: GitHub の created_at（リポジトリ作成日時）を YYYY/MM で記載しています。
- Star: 2025-12-31 時点の GitHub stargazers_count です。
- 状態/やり方: プロジェクト側で変わりやすいので、最新はリンク先の CONTRIBUTING / 翻訳ガイド等を確認してください。
...
- ライセンス: 複合
- やり方: フォークしてGitHubPages等でリリースして、リリースのリンクをプルリク？
- 状態: 翻訳についての議論例あり（参考: https://github.com/FortAwesome/Font-Awesome/pull/7360）
- 文章量: 中
- Star: 76,150

### [Semantic-Org/Semantic-UI](https://github.com/Semantic-Org/Semantic-UI)

- 概要: 自然言語の考え方を取り入れた UI コンポーネントフレームワーク https://semantic-ui.com
- 開始年月: 2013/04
- ライセンス: MIT
- やり方:
- 状態:
...
- 開始年月: 2013/05
- ライセンス: MIT
- やり方: ドキュメント用のレポジトリは [reactjs/react.dev](https://github.com/reactjs/react.dev) 。翻訳状況は https://translations.react.dev/ を参照。
- 状態: 翻訳は各言語フォークで進行（詳細は https://github.com/reactjs/react.dev/issues/4135 および react.dev の Translations ページ参照）
- 文章量: 多
- Star: 241,937 (ドキュメント: reactjs/react.dev は 11,621)

### [vuejs/docs](https://github.com/vuejs/docs)

- 概要: Vue 3 の公式ドキュメント
- 作者: [vuejs](https://github.com/vuejs)
- 開始年月: 2019/12
- ライセンス: CC BY 4.0（画像除く）
- やり方: 翻訳ガイドライン: https://github.com/vuejs-translations/guidelines/blob/main/README.md （日本語: https://github.com/vuejs-translations/docs-ja）
- 状態: 日本語あり（ja.vuejs.org）
- 文章量: 多
- Star: 3,167
...
- 概要: Node.js の JavaScript ランタイム https://nodejs.org
- 開始年月: 2014/11
- ライセンス: MIT
- やり方: nodejs.org の翻訳手順を参照: https://github.com/nodejs/nodejs.org/blob/main/docs/translation.md
- 状態: 日本語もありよく更新されている
- 文章量: 多
- Star: 114,968
...
- 概要: Node.js 公式サイト（nodejs.org）
- 作者: [nodejs](https://github.com/nodejs)
- 開始年月: 2015/06
- ライセンス: MIT
- やり方: Crowdin で翻訳（ポリシー: https://github.com/nodejs/nodejs.org/blob/main/docs/translation.md）
- 状態: 日本語あり
- 文章量: 中
- Star: 6,771
...
- 概要: JavaScript の 3D ライブラリ https://threejs.org/
- 開始年月: 2010/03
- ライセンス: MIT
- やり方:
- 状態:
...
- 概要: リアルタイム通信フレームワーク（Node.js） https://socket.io
- 開始年月: 2010/03
- ライセンス: MIT
- やり方:
- 状態:
...
- 概要: HTML 製のプレゼン（スライド）フレームワーク https://revealjs.com
- 開始年月: 2011/06
- ライセンス: MIT
- やり方:
- 状態:
...
- 開始年月: 2015/01
- ライセンス: MIT
- やり方: docs/README-ja.md, docs/RULES-ja.md を更新してプルリク
- 状態: 日本語あり
- 文章量: 中
- Star: 29,409
...
### [js-the-right-way](https://github.com/jstherightway/js-the-right-way)
...
- やり方: [専用のレポジトリを作っている](https://github.com/thejsway/thejsway/blob/master/CONTRIBUTING.md#translation-guidelines)
- 状態: 中国、インドネシアが活動中？
- 文章量: 多
- Star: 7,901
...
- 作者: [psf](https://github.com/psf)
- 開始年月: 2011/02
- ライセンス: Apache 2.0
- やり方: [専用レポジトリ](https://github.com/requests/requests-docs-jp) がある
- 状態: 日本語 docs は途中まで（requests-docs-jp / 最終更新: 2018/04）
- 文章量: 多
- Star: 53,609

### [python-doc-ja/python-doc-ja](https://github.com/python-doc-ja/python-doc-ja)

- 概要: Python ドキュメント日本語訳プロジェクト
- 作者: [python-doc-ja](https://github.com/python-doc-ja)
- 開始年月: 2015/05
- ライセンス: PSF License
- やり方: Transifex で翻訳（手順: https://github.com/python-doc-ja/python-doc-ja/wiki/HowToTransifex）
- 状態: 日本語あり（翻訳進行中）
- 文章量: 多
- Star: 148
...
- やり方: README_ja.md を更新してプルリク
- 状態: 日本語あり（README_ja.md）
- 文章量: 少
- Star: 42,480
...
- 概要: Helm 公式サイト/ドキュメント（helm.sh）
- 作者: [helm](https://github.com/helm)
- 開始年月: 2015/10
- ライセンス: MIT
- やり方: i18n/ja 配下を翻訳して PR（ガイド: https://github.com/helm/helm-www/blob/main/community/localization.md）
- 状態: 日本語あり（i18n/ja）
- 文章量: 多
- Star: 226
...
- 状態: 日本語あり（progit2-ja / 最終更新: 2022/10）
- 文章量: 多
- Star: 6,369
...
- 概要: Kubernetes 公式サイト/ドキュメント
- 作者: [kubernetes](https://github.com/kubernetes)
- 開始年月: 2016/02
- ライセンス: CC BY 4.0
- やり方: 翻訳ガイド: https://github.com/kubernetes/website/blob/main/content/en/docs/contribute/localization.md （日本語は content/ja 配下）
- 状態: 日本語あり（content/ja）
- 文章量: 多
- Star: 5,130
...
- 概要: MDN Web Docs の翻訳コンテンツ（日本語含む）
- 作者: [mdn](https://github.com/mdn)
- 開始年月: 2020/12
- ライセンス: 複合（文章: CC-BY-SA 2.5 / コード例: CC0 など）
- やり方: CONTRIBUTING.md: https://github.com/mdn/translated-content/blob/main/CONTRIBUTING.md （日本語ガイド: https://github.com/mdn/translated-content/blob/main/docs/ja/README.md）
- 状態: 日本語あり（files/ja）
- 文章量: 多
- Star: 1,936
...
- 概要: コンテナエコシステムのための共同プロジェクト https://mobyproject.org/
- 開始年月: 2013/01
- ライセンス: Apache 2.0
- やり方:
- 状態:
...
- 状態: 日本語あり（translations/README-ja.md）
- 文章量: 中
- Star: 335,429
